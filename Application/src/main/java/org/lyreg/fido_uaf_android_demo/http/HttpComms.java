...
public class HttpComms {
    ...
    public HttpComms(Context context) {
    ...
    public HttpResponse get(String relativeUrl) {
        ...
        try {
            ...
            Log.e("HttpComms", "get operation is finished");
            ...
            Log.e("HttpComms", "get errors " + e.getMessage());
    ...
    public HttpResponse post(String relativeUrl, String payload) {
        HttpURLConnection urlConnection = null;
